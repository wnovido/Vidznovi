...
angular.module('core').controller('HomeController', ['$scope', '$animate', 'Authentication', 'Albums', 'Albumgroups', 'Pictures', 'CarouselAlbum', '$rootScope',
	function($scope, $animate, Authentication, Albums, Albumgroups, Pictures, CarouselAlbum, $rootScope) {
